                        ...
                        <div class="col-lg-6">
                            <div class="event-content wow fadeInUp">
                                <div class="event-image">
                                    <img src="{{ $event->thumbnail ?? asset('assets/images/gallery/event-01.jpg') }}" alt="image">
                                </div>
                                <div class="event-wrapper">
                                    ...
                                    <a href="{{ route('events.show', $event->id) }}"><h5>{{ $event->name }}</h5></a>
                                    <div class="event-info">
                                        <a href="{{ route('events.show', $event->id) }}" class="btn-1 btn-2">View Events <span></span></a>
